...
import co.pford.presenter.fragments.FragmentPhraseWord;
...
public class PaperKeyActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cleanPhrase.charAt(cleanPhrase.length() - 1) == '\0') {
            ...
            throw new IllegalArgumentException("Paper Key error, please contact support at n8vcoin.io: " + wordArray.length);
        } else {
            if (wordArray.length != 12) {
                throw new IllegalArgumentException("Wrong number of paper keys: " + wordArray.length + ", lang: " + Locale.getDefault().getLanguage());
            }
