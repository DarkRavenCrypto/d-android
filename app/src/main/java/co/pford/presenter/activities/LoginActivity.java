...
import static co.pford.R.color.white;
import static co.pford.tools.util.BRConstants.PLATFORM_ON;
import static co.pford.tools.util.BRConstants.SCANNER_REQUEST;
...
public class LoginActivity extends BRActivity {
    ...
    private void updateDots() {
        AuthManager.getInstance().updateDots(this, pinLimit, pin.toString(), dot1, dot2, dot3, dot4, dot5, dot6, R.drawable.ic_pin_square_gray,
